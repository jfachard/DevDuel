...
export const GameOver: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-8 bg-gray-800 p-12 rounded-2xl shadow-2xl border border-gray-700 animate-fade-in">
      <h2 className={`text-6xl font-bold ${isWinner ? 'text-green-400' : 'text-red-500'}`}>
      ...
      <button
        ...
        className="px-8 py-3 bg-blue-600 hover:bg-blue-500 rounded-lg font-bold text-xl transition-transform transform hover:scale-105 shadow-lg"
      >
        Play Again
      </button>
    </div>
